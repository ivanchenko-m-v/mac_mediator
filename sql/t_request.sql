select t_request.i_request, t_request.i_mr, t_request.i_mediator, t_request.i_request_category, 
       ...
       t_administrative_division.x_administrative_division, t_municipal_district.x_municipal_district,
       t_mediator.x_mediator, t_request_category.x_request_category
       FROM t_request, t_administrative_division, t_municipal_district, t_mediator, t_request_category
       WHERE (
              ...
              (t_request.i_request_category=t_request_category.i_request_category)
             );
...
SELECT t_request.i_request, t_request.i_mr, t_request.i_mediator, t_request.i_request_category, 
       ...
       t_request.x_declarant_address, t_request.x_service_organization, t_request.x_request, 
       t_request.x_other_conflict_party, t_request.x_organization, t_request.x_consultation,
       t_administrative_division.i_administrative_division, 
       t_administrative_division.x_administrative_division, t_municipal_district.x_municipal_district,
       t_mediator.x_mediator, t_mediator.x_mediator_phone, t_request_category.x_request_category
       FROM t_request, t_administrative_division, t_municipal_district, t_mediator, t_request_category
       WHERE (
              (t_request.i_mr=t_municipal_district.i_municipal_district)AND
              (t_municipal_district.i_administrative_division=t_administrative_division.i_administrative_division)AND
...
SELECT i_request, i_mr, i_mediator, i_request_category, 
